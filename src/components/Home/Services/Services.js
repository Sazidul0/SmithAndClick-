...
const Services = () => {
    const services = [
        { id: 1, name: "Engagement", price: 1260, description: "The question was popped, you have said yes, it's a big deal. Get photographic evidence of the two of you in this giddy moment to remember.", img: image1 },
